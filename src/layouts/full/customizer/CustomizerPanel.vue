        ...
        <v-row class="ma-0">
          <v-col cols="12" class="pa-0">
            <div class="pa-5 d-flex justify-space-between align-center">
              <div class="text-subtitle-1 font-weight-medium">Změna čitelnosti</div>
              <div>
          ...
          <v-col cols="12" class="pa-0">
            ...
            <v-card-item class="py-5">
              <v-card-title class="text-subtitle-1 font-weight-medium mb-4">Font, který Vám vyhovuje</v-card-title>
            ...
            <div class="d-flex justify-space-between align-center pa-5">
              <div class="text-subtitle-1 font-weight-medium">Pozadí inputů formulářů</div>
              <div>
