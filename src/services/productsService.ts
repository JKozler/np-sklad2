...
export const productsService = {
  async getAll(filters?: ProductFilters, params?: ProductQueryParams): Promise<ProductsResponse> {
    ...
    queryParams.append('attributeSelect', 'abraId,code,name,stockType,productGroupId,productGroupName,costPrice,uomId,uomName,priceWithoutVat,vatRate,priceWithVat,ean,isStockItem,outageFlag,createdAt');
